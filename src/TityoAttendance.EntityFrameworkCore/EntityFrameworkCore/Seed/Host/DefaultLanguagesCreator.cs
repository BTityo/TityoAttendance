...
namespace TityoAttendance.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = TityoAttendanceConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
            return new List<ApplicationLanguage>
            {
                new ApplicationLanguage(tenantId, "en", "English", "famfamfam-flags gb"),
                new ApplicationLanguage(tenantId, "hu", "Magyar", "famfamfam-flags hu"),
        ...
        public DefaultLanguagesCreator(TityoAttendanceDbContext context)
        {
            _context = context;
        }
